...
public class Risposta {
    ...
    private Date dataRisposto, dataRisposta;
    private int creatoreRisposto, creatoreRisposta;

    public Risposta(Date dataRisposto, Date dataRisposta, int creatoreRisposto, int creatoreRisposta) {
